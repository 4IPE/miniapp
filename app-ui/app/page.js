        ...
        <Layout currentPage="home">
            <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <p className="text-red-300 text-center max-w-md">
                    Откройте для себя скрытый драгоценный камень VPN-технологии. RubyTunnel: Где безопасность сияет
                    ярко, как отполированный рубин.
                </p>
                ...
                <div className="w-full max-w-md space-y-4">
                    <div
                        className="bg-gradient-to-br from-red-900 via-red-800 to-black p-6 rounded-2xl shadow-2xl border-2 border-red-600 relative overflow-hidden">
